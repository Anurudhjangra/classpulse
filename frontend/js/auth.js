(function () {
  ...
  function showDevOtp() {
    ...
    box.textContent = "DEV MODE: OTP = " + pendingDevOtp + " (real SMS ke liye .env mein SMS_API_KEY daalo)";
  ...
  const FIELDS = {
    ...
    signup: [
      ...
      { id: "f-email", label: "Email", type: "email", placeholder: "you@school.com", autocomplete: "email" },
      { id: "f-mobile", label: "Mobile Number", type: "tel", placeholder: "9876543210", autocomplete: "tel", maxlength: 10, hint: "Forgot password ke liye OTP isi number par aayega" },
